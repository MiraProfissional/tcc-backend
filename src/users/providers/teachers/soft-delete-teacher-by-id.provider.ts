...
@Injectable()
export class SoftDeleteTeacherByIdProvider {
  constructor(
  ...
  /**
   * The method to soft delete a teacher from the database by ID
   */
  public async softDeleteTeacher(teacherId: number): Promise<UserDeleted> {
